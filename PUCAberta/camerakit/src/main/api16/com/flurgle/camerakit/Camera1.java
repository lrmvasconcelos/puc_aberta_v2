    ...
    private void resetFocus(final boolean success, final Camera camera) {
        ...
        try {
            ...
            if (camera != null) {
                ...
                if (params.getMaxNumFocusAreas() != 0 && focusMode != null &&
                        (focusMode.equals(Camera.Parameters.FOCUS_MODE_AUTO) ||
                                focusMode.equals(Camera.Parameters.FOCUS_MODE_MACRO) ||
                                focusMode.equals(Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE) ||
                                focusMode.equals(Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO))) {
            ...
            Log.d("CameraKit", "teria quebrado mas agora tem um try catch MUAHAHAAHA #fdp");
        }
    }

    private Rect calculateFocusArea(float x, float y) {
        int newY = (int) (2000 - x / mPreview.getView().getWidth() * 2000) - 1000;
        int newX = (int) (y / mPreview.getView().getHeight() * 2000) - 1000;
